...
import { useStreetview } from "../streetview/streetviewContext"
import { useMapData } from "./mapDataContext"

const MapView = lazy(() => import("../../components/MapView").then((module) => ({ default: module.MapView })))

/**
 * Único punto donde se conecta `MapView` con los providers. Cada uno expone
...
export function MapSlot(): React.JSX.Element {
  ...
  const { mapViewProps: streetviewProps } = useStreetview()

  return <MapView {...dataProps} {...selectionProps} {...streetviewProps} />
}
